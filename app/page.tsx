...
const bots = [
  ...
  {
    name: "Joke Bot",
    description: "Enjoy AI-generated jokes",
    icon: Laugh,
    href: "/joke-bot",
    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-800 to-black text-white">
      ...
      <main className="container mx-auto px-4 py-16">
        <header className="text-center mb-16">
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-stone-200 via-blue-500 to-teal-600">
            Welcome to AI-Verse
          </h1>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <CardFooter className="flex justify-end">
                  <Link href={bot.href} className="">
                    <Button
                      variant={"default"}
                      className={`text-zinc-800 rounded-3xl ${bot.btngradiant} hover:bg-zinc-300 w-full flex items-center justify-center`}
                    >
                      Try {bot.name}
